    ...
    <div style={styles.container}>
      ...
      <div style={styles.sidebar}>
        ...
        <div style={{ ...styles.userInfo, cursor: 'pointer' }} onClick={() => navigate('/admin/profile')}>
            ...
            <div>
              ...
              <p style={styles.userRole}>{getRoleText()}</p>
            </div>
          </div>
      ...
      <div style={styles.main}>
        ...
        <div style={styles.profileHeader}>
          <div style={styles.rolePillWrap}>
            <span style={styles.rolePill}>
              {isSuperAdmin ? '👑 Akun Super Admin' : '🛡 Akun Admin/Instansi'}
            </span>
          </div>
        ...
        <div style={styles.grid}>
          ...
          <div style={styles.card}>
            <h3 style={styles.cardTitle}>Informasi Instansi</h3>
            <div style={styles.infoList}>
              ...
              <div style={styles.infoItem}>
                ...
                <span style={styles.roleTag}>{getRoleText()}</span>
              </div>
            </div>
          </div>
          ...
          {/* Kinerja Penanganan */}
          <div style={styles.card}>
            <h3 style={styles.cardTitle}>Kinerja Penanganan Laporan</h3>
        ...
        <div style={styles.section}>
          <div style={styles.sectionHeader}>
            <h3 style={styles.cardTitle}>Laporan Terbaru Masuk</h3>
            <Link to="/admin/laporan" style={styles.lihatSemua}>Kelola semua</Link>
          </div>
          {reports.length === 0 ? (
            ...
            reports.slice(0, 5).map((report) => (
              <Link to={`/report/${report.id}`} key={report.id} style={styles.reportItem}>
                <div>
                  ...
                  <p style={styles.reportMeta}>{report.username} • {report.category_name} • {new Date(report.created_at).toLocaleDateString('id-ID')}</p>
                </div>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  rolePillWrap: { marginBottom: '1rem' },
  rolePill: { fontSize: '12px', padding: '4px 12px', borderRadius: '20px', backgroundColor: '#fff8e1', color: '#f39c12', fontWeight: '500' },
  ...
  roleTag: { fontSize: '11px', padding: '3px 10px', borderRadius: '20px', backgroundColor: '#e3f2fd', color: '#3498db', fontWeight: '500' },
  ...
  statLabel: { margin: 0, fontSize: '11px', color: '#aaa', textAlign: 'center' },
